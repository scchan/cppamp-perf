; ModuleID = '/tmp/tmplf7j9832/5-linked-path'
...
.9:
  ...
  %1 = zext i32 %0 to i64
  %_dot_.12836.i = getelementptr [2 x i64] addrspace(3)* @_hsapy_smem, i64 0, i64 %1
  %_dot_.128.i = addrspacecast i64 addrspace(3)* %_dot_.12836.i to i64 addrspace(4)*
  store i64 666, i64 addrspace(4)* %_dot_.128.i, align 8
  tail call spir_func void @__hsail_barrier() #0
  %_dot_.161.i = icmp eq i32 %0, 0
  br i1 %_dot_.161.i, label %B97.thread.i, label %B97.i

B97.thread.i:                                     ; preds = %.9
...
B97.i:                                            ; preds = %.9
  tail call spir_func void @__hsail_barrier() #0
  %_dot_.271.i = icmp eq i32 %0, 1
  br i1 %_dot_.271.i, label %B122.i, label %hsapy_devfn__5F__5F_main_5F__5F__2E_foo_24_1_2E_array_28_int64_2C__20_1d_2C__20_C_29_.exit

B122.i:                                           ; preds = %B97.i
  %_dot_.302.i = load i64 addrspace(4)* %_dot_.128.i, align 8
  br label %hsapy_devfn__5F__5F_main_5F__5F__2E_foo_24_1_2E_array_28_int64_2C__20_1d_2C__20_C_29_.exit

hsapy_devfn__5F__5F_main_5F__5F__2E_foo_24_1_2E_array_28_int64_2C__20_1d_2C__20_C_29_.exit: ; preds = %B97.thread.i, %B97.i, %B122.i
  %storemerge.i = phi i64 [ %_dot_.302.i, %B122.i ], [ 456, %B97.i ], [ 456, %B97.thread.i ]
  tail call spir_func void @__hsail_barrier() #0
  %_dot_.373.i1 = getelementptr i64 addrspace(1)* %_dot_.5, i64 %1
  %_dot_.373.i = addrspacecast i64 addrspace(1)* %_dot_.373.i1 to i64 addrspace(4)*
  store i64 %storemerge.i, i64 addrspace(4)* %_dot_.373.i, align 8
  ret void
}
